...
echo $TIME $UTIME $CPU $MEM $LOADAVE $DF $DFDATA $DFDATA1 $IMGFC $HEALTHFC $DONEFC $PARTSFC $NUMZOMB $NUMPDOG $NUMSTIMG $NUMDCOL $NUMSCHED $NUMSSM $STIMG0 $STIMG1 $STIMG2 $STIMG3 $STIMG4 $SCHED0 $SCHED1 $SCHED2
