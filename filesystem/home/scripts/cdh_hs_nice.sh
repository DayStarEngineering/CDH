...
SCHED2=${SCHED2:12:8}
SCHED3=$(stcl sched get 3)
SCHED3=${SCHED3:12:8}
SCHED4=$(stcl sched get 4)
SCHED4=${SCHED4:12:8}
...
echo $TIME $UTIME $CPU $MEM $LOADAVE $DF $DFDATA $DFDATA1 $DFDATA2 $IMGFC0 $IMGFC1 $IMGFC2 $HEALTHFC $DONEFC $PARTSFC $NUMZOMB $NUMPDOG $NUMSTIMG $NUMDCOL $NUMSCHED $NUMSSM $STIMG0 $STIMG1 $STIMG2 $STIMG3 $STIMG4 $STIMG5 $SCHED0 $SCHED1 $SCHED2 $SCHED3 $SCHED4
