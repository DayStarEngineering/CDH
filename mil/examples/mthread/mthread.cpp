...
int MosMain(void)
   ...
   MbufChild2d(MilImage, 0,            0, IMAGE_WIDTH, IMAGE_HEIGHT, &TParTopLeft.SrcImage);
   MbufChild2d(MilImage, 0, IMAGE_HEIGHT, IMAGE_WIDTH, IMAGE_HEIGHT, &TParBotLeft.DstImage);
   MbufChild2d(MilImage, IMAGE_WIDTH,  0, IMAGE_WIDTH, IMAGE_HEIGHT, &TParTopRight.SrcImage);
   ...
   /* Intitalize remaining thread parameters. */
