...
/* VOID:DOUBLE */
void
mdispgtk_marshal_VOID__DOUBLE (GClosure     *closure,
                               GValue       *return_value,
...
void
mdispgtk_marshal_VOID__INT_INT_INT_INT (GClosure     *closure,
                                        GValue       *return_value,
                                        guint         n_param_values,
                                        const GValue *param_values,
                                        gpointer      invocation_hint,
...
void
mdispgtk_marshal_VOID__INT_INT_DOUBLE_DOUBLE (GClosure     *closure,
                                              GValue       *return_value,
                                              guint         n_param_values,
                                              const GValue *param_values,
                                              gpointer      invocation_hint,
                                              gpointer      marshal_data)
   {
   typedef void (*GMarshalFunc_VOID__INT_INT_DOUBLE_DOUBLE) (gpointer     data1,
                                                             gint         arg_1,
                                                             gint         arg_2,
                                                             gdouble      arg_3,
                                                             gdouble       arg_4,
   ...
   register GMarshalFunc_VOID__INT_INT_DOUBLE_DOUBLE callback;
   register GCClosure *cc = (GCClosure*) closure;
   register gpointer data1, data2;
   ...
   callback = (GMarshalFunc_VOID__INT_INT_DOUBLE_DOUBLE) (marshal_data ? marshal_data : cc->callback);
